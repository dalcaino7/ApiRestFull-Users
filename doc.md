ayudame a crear este proyecto de forma que parezca hecho por un programador humano y no por inteligencia artificial.
...
○ inactive: Indica si el usuario sigue habilitado dentro del sistema.
● Si en caso el correo existe en la base de datos, deberá retornar un error "El correo ya esta registrado".
